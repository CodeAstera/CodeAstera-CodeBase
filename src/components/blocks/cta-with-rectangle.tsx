...
export function CTASection({
  ...
  return (
    <section className={cn("overflow-hidden pt-0 md:pt-0 pb-28", className)}>
      <div className="relative mx-auto flex max-w-container flex-col items-center gap-6 px-8 py-12 text-center sm:gap-8 md:py-24">
        ...
        {title}{" "}
        <span className="text-transparent bg-clip-text bg-gradient-to-b from-sky-200 from-20% to-sky-400 drop-shadow-[0_0_4px_rgba(155,221,251,0.9)]">CodeAstera</span>
        </h2>
        ...
        <Button
          ...
          size="lg"
          className="opacity-0 animate-fade-in-up delay-500 bg-white"
          asChild
        >
